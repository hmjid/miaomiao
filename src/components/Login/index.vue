<template>
  <div id="content">
    <div class="login_body">
      <div>
        <input type="text" placeholder="账户名/手机号/Email" class="login_text" v-model="username" />
      </div>
      <div>
        <input type="password" placeholder="请输入您的密码" class="login_text" v-model="password" />
      </div>
      <div>
        <input type="text" placeholder="请输入下面验证码" v-model="verifyImg" class="login_text" />
